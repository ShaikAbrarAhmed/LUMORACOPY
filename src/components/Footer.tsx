        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 md:gap-6">
          ...
          <div className="text-left space-y-4">
            ...
            <div className="flex items-center gap-4 pt-1">
              ...
              <Link href="https://www.instagram.com/lumorous.space?igsh=Y3Rxa2poOWk2cXNk" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors" aria-label="Instagram">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <div className="text-left">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="https://www.instagram.com/lumorous.space?igsh=Y3Rxa2poOWk2cXNk" target="_blank" rel="noopener noreferrer" className="text-xs text-muted-foreground hover:text-primary transition-colors font-light">Instagram</Link>
              </li>
            </ul>
          </div>
