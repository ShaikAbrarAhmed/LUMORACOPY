        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 md:gap-6">
          ...
          <div className="text-left space-y-4">
            ...
            <div className="flex items-center gap-4 pt-1">
              <Link href="https://discord.gg/xWVsJWv8N" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors" aria-label="Discord">
              ...
              <Link href="https://chat.whatsapp.com/GgKs2Hnh8Os1XOL0pYPZMN" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors" aria-label="WhatsApp">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z"/>
                </svg>
              </Link>
              <Link href="https://www.instagram.com/lumora.spacee?utm_source=qr&igsh=Y3Rxa2poOWk2cXNk" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors" aria-label="Instagram">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <div className="text-left">
            ...
            <ul className="space-y-2">
              <li>
                <Link href="https://discord.gg/xWVsJWv8N" target="_blank" rel="noopener noreferrer" className="text-xs text-muted-foreground hover:text-primary transition-colors font-light">Discord</Link>
              </li>
              <li>
                <Link href="https://chat.whatsapp.com/GgKs2Hnh8Os1XOL0pYPZMN" target="_blank" rel="noopener noreferrer" className="text-xs text-muted-foreground hover:text-primary transition-colors font-light">WhatsApp</Link>
              </li>
              <li>
                <Link href="https://www.instagram.com/lumora.spacee?utm_source=qr&igsh=Y3Rxa2poOWk2cXNk" target="_blank" rel="noopener noreferrer" className="text-xs text-muted-foreground hover:text-primary transition-colors font-light">Instagram</Link>
              </li>
            </ul>
          </div>
          ...
          <div className="text-left">
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/privacy" className="text-xs text-muted-foreground hover:text-primary transition-colors font-light">Privacy Policy</Link>
              </li>
              <li>
                <Link href="/terms" className="text-xs text-muted-foreground hover:text-primary transition-colors font-light">Terms of Service</Link>
              </li>
              <li>
                <a href="mailto:Support.lumoraspace@gmail.com" className="text-xs text-muted-foreground hover:text-primary transition-colors font-light">Contact</a>
              </li>
            </ul>
          </div>
