...
export function Logo({
  ...
  return (
    <div
      className={`relative flex items-center justify-center rounded-xl overflow-hidden bg-[#2D2433] border border-slate-200/50 shadow-[0_4px_20px_rgba(11,16,32,0.08)] shrink-0 p-1.5 ${sizeClasses[size]} ${className}`}
    >
      <Image
        src="/logo.png"
        alt="Lumora Logo"
