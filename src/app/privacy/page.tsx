      ...
      <div className="max-w-3xl mx-auto px-6 lg:px-8">
        <div className="space-y-8">
          ...
          <div className="prose prose-slate max-w-none space-y-6 text-slate-600">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-slate-900 mb-3">2. Data We Collect</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-slate-900 mb-3">3. How We Use Your Data</h2>
              <p>
            ...
            <div className="p-4 mt-8 bg-amber-50 border border-amber-200 rounded-lg text-amber-800 text-sm">
              <strong>Note:</strong> This is a placeholder Privacy Policy. You should replace this with a legally binding document reviewed by your legal counsel.
            </div>
          </div>
        </div>
      </div>
