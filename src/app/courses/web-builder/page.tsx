...
export default function WebBuilderPage() {
  ...
  const mentors = [
    ...
    },
    {
      ...
      company: "LumberFi",
      expertise: "Product Management • Design Thinking • Frontend Development",
  ...
  const features = [
    ...
    },
    {
      ...
      desc: "Build 5+ real-world web applications"
    },
    {
      icon: Target,
      title: "Code Reviews",
    ...
    },
    {
      icon: Layout,
      title: "Modern Stack",
      desc: "Learn React, TypeScript, and modern web development tools"
    },
    {
      icon: Award,
      title: "Certificate",
      ...
      <section className="relative pt-32 pb-16 md:pt-36 md:pb-20 px-6 w-full flex flex-col items-center text-center z-10">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-slate-400 font-light leading-relaxed max-w-3xl mx-auto mb-12">
            ...
            Master frontend architecture, interactive JavaScript, and team collaboration.
          </p>
