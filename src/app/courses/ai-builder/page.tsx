...
export default function AIBuilderPage() {
  ...
  const mentors = [
    {
      ...
      role: "Marketing Specialist & Mentor",
      company: "BOT Consulting",
      expertise: "AI Marketing • AI Tools • Product Development",
  ...
  const features = [
    ...
    },
    {
      ...
      desc: "Build 3+ AI-powered applications"
    },
    {
      icon: Bot,
      title: "AI Tool Mastery",
      desc: "Master cutting-edge AI tools and frameworks"
    },
    {
      icon: Zap,
      title: "Live Sessions",
      ...
      <section className="relative pt-32 pb-16 md:pt-36 md:pb-20 px-6 w-full flex flex-col items-center text-center z-10">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-slate-400 font-light leading-relaxed max-w-3xl mx-auto mb-12">
            Explore AI workflows, modern tools, and intelligent product development. 
            Learn to leverage AI to build innovative solutions and stay ahead in the tech landscape.
          </p>
