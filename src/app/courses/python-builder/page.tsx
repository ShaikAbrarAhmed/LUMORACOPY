...
export default function PythonBuilderPage() {
  const curriculum = [
    {
      week: "Week 1-2",
  ...
  const mentors = [
    {
      ...
      expertise: "Leadership • Product Management • Software Development",
  ...
  const features = [
    ...
    },
    {
      ...
      desc: "Build 5+ real-world projects throughout the program"
    },
    {
      icon: Target,
      title: "Code Reviews",
      desc: "Weekly code reviews with detailed feedback from mentors"
    },
    {
      icon: Zap,
      title: "Live Sessions",
      desc: "2 live sessions per week for Q&A and doubt clearing"
    },
    {
      icon: Award,
      title: "Certificate",
      ...
      <section className="relative pt-32 pb-16 md:pt-36 md:pb-20 px-6 w-full flex flex-col items-center text-center z-10">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-slate-400 font-light leading-relaxed max-w-3xl mx-auto mb-12">
            Learn programming fundamentals and develop problem-solving skills through structured implementation. 
            Build a strong foundation in Python with hands-on projects and expert mentorship.
          </p>
