...
export const metadata: Metadata = {
  ...
  description: "Join the LumoraSpace student developer and designer community. Collaborate on hackathons, pair program on sprints, and gain feedback from peer builders.",
  alternates: {
    canonical: "/community",
  },
  openGraph: {
    ...
    title: "Builder Community | LumoraSpace Space",
    description: "Join the LumoraSpace student developer and designer community. Collaborate on hackathons, pair program on sprints, and gain feedback from peer builders.",
    images: [
      {
        url: "/logo4.png",
        width: 1200,
        height: 630,
        alt: "LumoraSpace Builder Community",
      },
    ],
  },
  twitter: {
