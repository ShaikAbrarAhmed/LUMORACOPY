        ...
        <div className="space-y-8">
          ...
          <div className="prose prose-slate max-w-none space-y-6 text-slate-600">
            ...
            <div className="p-4 mt-8 bg-amber-50 border border-amber-200 rounded-lg text-amber-800 text-sm">
              <strong>Note:</strong> This is a placeholder Terms of Service document. You should replace this with a legally binding document reviewed by your legal counsel.
            </div>
          </div>
        </div>
      </div>
