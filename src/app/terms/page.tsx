      ...
      <div className="flex-1 pt-36 pb-16">
        <div className="max-w-3xl mx-auto px-6 lg:px-8">
          <div className="space-y-8">
            <div>
              <h1 className="text-4xl font-bold tracking-tight text-[#0B1020] mb-4">Terms of Service</h1>
              <p className="text-slate-500">Last updated: {new Date().toLocaleDateString()}</p>
            </div>
            
            <div className="prose prose-slate max-w-none space-y-6 text-slate-600">
              <section>
                <h2 className="text-2xl font-semibold text-[#0B1020] mb-3">1. Agreement to Terms</h2>
                <p>
              ...
              <section>
                <h2 className="text-2xl font-semibold text-[#0B1020] mb-3">2. Use License</h2>
                <p>
              ...
              <section>
                <h2 className="text-2xl font-semibold text-[#0B1020] mb-3">3. User Accounts</h2>
                <p>
              ...
              <section>
                <h2 className="text-2xl font-semibold text-[#0B1020] mb-3">4. Limitations</h2>
                <p>
              ...
              <section>
                <h2 className="text-2xl font-semibold text-[#0B1020] mb-3">5. Revisions and Errata</h2>
                <p>
              ...
              <section>
                <h2 className="text-2xl font-semibold text-[#0B1020] mb-3">6. Governing Law</h2>
                <p>
              ...
              <section>
                <h2 className="text-2xl font-semibold text-[#0B1020] mb-3">Contact</h2>
                <p>
